      ...
      builder: (context) {
        if (authStore.error != null) {
          return ListTile(
            ...
            trailing: FilledButton.tonal(onPressed: authStore.init, child: const Text('Reconnect')),
          );
        }
        if (authStore.isLoggedIn && authStore.user.details != null) {
          return ListTile(
            leading: ProfilePicture(userLogin: authStore.user.details!.login, radius: 12),
